...
<html>
	...
	<div class = "container mt-3 mb-3">
			...
			<h1><b>UPLOAD VIDEO TUTORIAL FOR PYTHON COURSE</b></h1>
			<hr/>
				
				<a href = "py_upload.php" class = "btn btn-primary mt-3"> UPLOAD A NEW VIDEO </a>
			...
			<div class = "row video-grid">
				...
				<div class = "col-md-4 video-cnt">
					...
					<source src = "<?php echo 'py_vid/'.$row['name'] ?>">
					</video>
					<?php
					echo '<button class="delete btn-success"><a href="py_del.php?deleteid='.$id.'">Delete above video</a></button>'
					?>
