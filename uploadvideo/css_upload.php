...
if(isset($_POST['upload'])) 
{
	...
	$file_destination = "css_vid/".$file_name;
	...
	if ($file_name=="") {
		...
		$q = "INSERT INTO css (name) VALUES ('$file_name')";
	...
	<body>
		...
		<div class = "container mt-3">
			...
			<div class = "col-lg-8 m-auto">
				<form action = "css_upload.php" method = "post" enctype = "multipart/form-data">
